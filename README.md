# nvim-treesitter-queries-embedded_template

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-embedded_template/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-embedded_template/actions/workflows/validate.yml)

Neovim tree-sitter queries for **embedded_template**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-embedded_template",
...
- [ ] Changes are scoped to `embedded_template` — do not include files for other languages
